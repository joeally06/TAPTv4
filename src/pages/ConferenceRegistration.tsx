            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-md">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-gray-600">Registration Fee (per attendee):</span>
                      <span className="font-medium">${registrationFee.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-gray-600">Number of Attendees:</span>
                      <span className="font-medium">{formData.totalAttendees}</span>
                    </div>
              ...
              <div className="pt-6">
                <button
                  ...
                  className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-lg font-medium text-white bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
                ...
                <p className="mt-3 text-sm text-gray-500 text-center">
                  Please mail your payment check after submitting the registration form.
                </p>
              </div>
            </div>
          </form>
